...
function Dialog(element) {
    ...
    this.talk = new Talk($('.js-talk', div));

    this.talk.addItem('Test Test Test Test', 'Hello! Hello! Hello! Hello! Hello!');
    this.talk.addItem('Test Test Test Test', 'Hello! Hello! Hello! Hello!');
    this.talk.addItem('Test Test Test Test', 'Hello! Hello! Hello!');
    this.talk.addItem('Test Test Test Test', 'Hello! Hello!');
    this.talk.addItem('Test Test Test Test', 'Hello!');
